...
const HeroSection = () => {
  return (
    <section className="relative min-h-[600px] w-full overflow-hidden bg-gradient-to-br from-purple-950 via-indigo-950 to-indigo-950">
      ...
      <div className="container relative mx-auto flex h-full flex-col items-center justify-center px-14 py-24 md:flex-row md:py-32">
        {/* Content */}
        ...
        <div className="mt-12 flex-1 md:mt-0">
          <div
            className={cn(
              "relative mx-auto h-[380px] w-[440px] rounded-2xl overflow-hidden",
              "bg-gradient-to-br from-white/5 to-transparent",
              "border border-primary/20 backdrop-blur-lg",
              "shadow-2xl shadow-indigo-500/10"
            )}
          >
            <img src="/hero.jpg" alt="Illustration for the blog" className="object-cover w-full h-full" />
          </div>
        </div>
      </div>
    </section>
